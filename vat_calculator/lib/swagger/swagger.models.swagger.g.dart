...
RWorkstationProduct _$RWorkstationProductFromJson(Map<String, dynamic> json) =>
    RWorkstationProduct(
      ...
      leftOvers: (json['leftOvers'] as num?)?.toDouble(),
      price: (json['price'] as num?)?.toDouble(),
      productId: json['productId'] as num?,
      productName: json['productName'] as String?,
...
Customer _$CustomerFromJson(Map<String, dynamic> json) => Customer(
      ...
      dataAccesso: json['DataAccesso'] as String?,
      datadinascita: json['Datadinascita'] as String?,
      email: json['Email'] as String?,
      location: customerLocationFromJson(json['Location']),
...
Map<String, dynamic> _$CustomerToJson(Customer instance) => <String, dynamic>{
      ...
      'DataAccesso': instance.dataAccesso,
      'Datadinascita': instance.datadinascita,
      'Email': instance.email,
      'Location': customerLocationToJson(instance.location),
      'Nome': instance.nome,
