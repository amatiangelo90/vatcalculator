                ...
                press: () async {
                  if(_nameController.text.isEmpty || _nameController.text == ''){
                    ...
                    ProductModel productModel = ProductModel(
                        ...
                        fkSupplierId: widget.product.fkSupplierId
                    );
                    ...
                    if(performSaveProduct != null && performSaveProduct.statusCode == 200){
                      ...
                      buildSnackBar(text: 'Si sono verificati problemi durante l\'aggiornamento del prodotto. Risposta servizio: ' + performSaveProduct.toString(), color: kPinaColor);
                    }
