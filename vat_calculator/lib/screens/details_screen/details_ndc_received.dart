...
class NDCReceivedDetailsPage extends StatefulWidget {


  static String routeName = 'ndc_ricevute_details_page';

  @override
  State<NDCReceivedDetailsPage> createState() =>
      _NDCReceivedDetailsPageState();

  const NDCReceivedDetailsPage({Key key}) : super(key: key);
}

class _NDCReceivedDetailsPageState
    extends State<NDCReceivedDetailsPage> {
      ...
      builder: (child, dataBundleNotifier, _){
        return Scaffold(
            appBar: AppBar(
              ...
              centerTitle: true,
              title: const Text('  Dettaglio NDC Ricevute'),
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  dataBundleNotifier.extractedNdc.isNotEmpty ? Column(
                    children: buildListFattureAcquistiDetails(
                        dataBundleNotifier.extractedNdc, height),
                  ) : Center(child: const Text('Non sono presenti ndc per il periodo indicato')),
                ],
              ),
            )
        );
  ...
  buildListFattureAcquistiDetails(
      List<ResponseAcquistiApi> extractedNdcRicevuteList, double height) {
    List<Widget> outList = [];

    extractedNdcRicevuteList.forEach((extractedNdcItem) {
      outList.add(
        Padding(
                                            ...
                                            child: SingleChildScrollView(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  buildRowDetails('Nome: ', extractedNdcItem.nome),
                                                  buildRowDetails('Id Fornitore: ', extractedNdcItem.id_fornitore),
                                                  ...
                                                  buildRowDetails('Importo Iva: ', '€ ' + extractedNdcItem.importo_iva),
