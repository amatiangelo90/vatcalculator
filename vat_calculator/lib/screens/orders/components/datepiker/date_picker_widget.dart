...
class DatePickerOrders extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _DatePickerOrdersState();
}

class _DatePickerOrdersState extends State<DatePickerOrders> {
...
class DatePickerController {
  _DatePickerOrdersState _datePickerState;

  void setDatePickerState(_DatePickerOrdersState state) {
