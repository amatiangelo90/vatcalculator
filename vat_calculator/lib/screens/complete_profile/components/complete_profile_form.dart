    ...
    return Form(
      ...
      child: Column(
        children: [
            ...
            if (_formKey.currentState!.validate()) {
              ...
              try{
                ...
                if(newUser != null){
                  ...
                  Timer(const Duration(milliseconds: 2500), ()=> Navigator.push(context, MaterialPageRoute(builder: (context) => LandingScreen(email: _auth.currentUser!.email!,),),),);
          ...
          }, child: Text('Crea profilo ed accedi'))
        ],
      ),
    );
  }
